...
L.Whisper_Queue 		= "An other auction is currently running. Your Item has been queued."
L.Whisper_Bid_OK 		= "Your bid of %d DKP was accepted."
L.Whisper_InUse 		= "<remove me>"
L.Message_StartBidding		= "Please bid on %s now by whispering [%s]! Lowest possible bid: %d"
